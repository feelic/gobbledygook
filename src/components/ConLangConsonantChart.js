...
import styles from "./ConLangConsonantChart.module.scss";

export default function ConLangConsonantChart(props) {
  const { lang } = props;
  return (
      <Fragment>
        <table className={styles.table}>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{lang.consonants['q'] && 'q'}	{lang.consonants['ɢ'] && 'ɢ'}</td>
            ...
            <tr>
              ...
              <td>{lang.consonants['ɸ'] && 'ɸ'}	{lang.consonants['β'] && 'β'}</td>
              <td>{lang.consonants['f'] && 'f'}	{lang.consonants['v'] && 'v'}</td>
              <td>{lang.consonants['θ̼'] && 'θ̼'}	{lang.consonants['ð̼'] && 'ð̼'}</td>
              <td>{lang.consonants['θ'] && 'θ'}	{lang.consonants['ð'] && 'ð'}</td>
              <td>{lang.consonants['θ̠'] && 'θ̠'}	{lang.consonants['ð̠'] && 'ð̠'}</td>
              <td>{lang.consonants['ɹ̠̊˔'] && 'ɹ̠̊˔'}	{lang.consonants['ɹ̠˔'] && 'ɹ̠˔'}</td>
              <td>{lang.consonants['ɻ˔'] && 'ɻ˔'}	</td>
              <td>{lang.consonants['ç'] && 'ç'}	{lang.consonants['ʝ'] && 'ʝ'}</td>
              <td>{lang.consonants['x'] && 'x'}	{lang.consonants['ɣ'] && 'ɣ'}</td>
              <td>{lang.consonants['χ'] && 'χ'}	{lang.consonants['ʁ'] && 'ʁ'}</td>
              <td>{lang.consonants['ħ'] && 'ħ'}	{lang.consonants['ʕ'] && 'ʕ'}</td>
              <td>{lang.consonants['h'] && 'h'}	{lang.consonants['ɦ'] && 'ɦ'}</td>
            </tr>
            <tr>
              <th>Approximant</th>
              <td></td>
